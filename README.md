...
# Atelier Questions and Answers API service
The Atelier Questions and Answers API has been refractored as a microservice from the existing monolithic API of an e-commerce website, Atelier. It responds to serveral RESTful endpoints detailed below.
